...
const CONTRACTORS = [
  "M/s. Sharma Electricals, Udaipur",
  "M/s. Rajasthan Electric Works, Udaipur",
  "M/s. Mewar Contractors, Udaipur",
  "M/s. Singh Brothers, Rajsamand",
  "M/s. Jain & Sons, Udaipur",
  "M/s. Gupta Enterprises, Udaipur-I",
  "M/s. Verma Constructions, Udaipur-II",
  "M/s. Patel Works, Rajsamand",
  "M/s. Solanki Electricals, Udaipur",
  "M/s. Mathur Traders, Udaipur",
];
